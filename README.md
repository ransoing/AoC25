...
## [Advent of Code 2025](https://adventofcode.com/2025) solutions in typescript

I'm aiming for solutions that have few lines of code while being reasonably readable.

Set up by installing [Node v18](https://nodejs.org/en/) and running `npm i` in the repo's directory.
